...
// Declare cosine similarity kernels for all supported <dim, avx_level> combinations
#define SVS_CS_EXTERN(DIM, LEVEL) SVS_INSTANTIATE_CS(extern template, DIM, LEVEL)
SVS_FOR_EACH_DISPATCH_TARGET(SVS_CS_EXTERN)
#undef SVS_CS_EXTERN
