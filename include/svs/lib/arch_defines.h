...
#define SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(              \
    microarch, return_type, cls, method, template_args, args \
)                                                            \
    extern template return_type cls<svs::arch::MicroArch::microarch>::method<template_args>(args);
...
#define SVS_EXTERN_CLASS_METHOD_nehalem(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(nehalem, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_westmere(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(westmere, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_sandybridge(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(sandybridge, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_ivybridge(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(ivybridge, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_haswell(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(haswell, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_broadwell(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(broadwell, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_skylake(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(skylake, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_x86_64_v4(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(x86_64_v4, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_skylake_avx512(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(skylake_avx512, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_cascadelake(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(cascadelake, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_cooperlake(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(cooperlake, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_icelake_client(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(icelake_client, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_icelake_server(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(icelake_server, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_sapphirerapids(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(sapphirerapids, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_graniterapids(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(graniterapids, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_graniterapids_d(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(graniterapids_d, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_m1(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(m1, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_m2(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(m2, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_neoverse_v1(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(neoverse_v1, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
...
#define SVS_EXTERN_CLASS_METHOD_neoverse_n2(return_type, cls, method, template_args, args) \
    SVS_EXT_CLASS_METHOD_TMPL_BY_MICROARCH(neoverse_n2, return_type, cls, method, SVS_PACK_ARGS(template_args), SVS_PACK_ARGS(args))
#else
