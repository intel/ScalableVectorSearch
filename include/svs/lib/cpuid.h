...
enum class ISAExt {
    // Common extensions
    MMX, SSE, SSE2, SSE3, SSSE3, SSE4_1, SSE4_2, POPCNT, CX16, SAHF, FXSR,
    AVX, XSAVE, PCLMUL, FSGSBASE, RDRND, F16C, AVX2, BMI, BMI2, LZCNT, FMA,
    MOVBE, RDSEED, ADCX, PREFETCHW, AES, CLFLUSHOPT, XSAVEC, XSAVES, SGX,
    CLWB, PKU, SHA, GFNI, VAES, VPCLMULQDQ, RDPID, PCONFIG, WBNOINVD, MOVDIRI, MOVDIR64B,
    ENQCMD, CLDEMOTE, PTWRITE, WAITPKG, SERIALIZE, TSXLDTRK, UINTR, PREFETCHI,

    // AVX family
    AVX_VNNI,

    // AVX512_ family
    AVX512_F, AVX512_VL, AVX512_BW, AVX512_DQ, AVX512_CD, AVX512_VBMI, AVX512_IFMA, AVX512_VNNI,
    AVX512_VBMI2, AVX512_BITALG, AVX512_VPOPCNTDQ, AVX512_BF16, AVX512_FP16,

    // AMX family
    AMX_BF16, AMX_TILE, AMX_INT8, AMX_FP16, AMX_COMPLEX
};
...
// TODO: complete support of __aarch64__
enum class ISAExt {
    SVE, SVE2
};
...
inline uint64_t read_system_reg() {
    uint64_t val;
...
inline bool check_extension(ISAExt ext) {
    return ISAExtInfo.at(ext).get_value();
}
