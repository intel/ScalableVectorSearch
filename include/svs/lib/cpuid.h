...
inline const std::unordered_map<ISAExt, CPUIDFlag>& get_isa_ext_info() {
    static const std::unordered_map<ISAExt, CPUIDFlag> isa_ext_info = {
...
inline const std::unordered_map<ISAExt, BrandInfo>& get_isa_ext_info() {
    static const std::unordered_map<ISAExt, BrandInfo> isa_ext_info = {
        {ISAExt::M1, {"M1"}},
        {ISAExt::M2, {"M2"}},
    };
    return isa_ext_info;
...
inline const std::unordered_map<ISAExt, MSRFlag>& get_isa_ext_info() {
    static const std::unordered_map<ISAExt, MSRFlag> isa_ext_info = {
