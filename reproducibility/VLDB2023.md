This page contains the information required to reproduce the experimental results of our research paper *Similarity search in the blink of an eye  
with compressed indices* [[ABHT23]](#1) published at VLDB 2023 ([arxiv version](https://arxiv.org/abs/2304.04759)).
...
$G_t$ is the ground-truth. We use $k=10$ in all experiments.
