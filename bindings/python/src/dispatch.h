...
struct svs::lib::DispatchConverter<
    ...
    svs::VectorDataLoader<T, N, RebindAllocator<T>>> {
    using To = svs::VectorDataLoader<T, N, RebindAllocator<T>>;
...
struct svs::lib::DispatchConverter<
    ...
    svs::quantization::lvq::
        LVQLoader<Primary, Residual, Extent, Strategy, RebindAllocator<std::byte>>> {
