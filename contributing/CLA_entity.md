...
Thank you for your interest in contributing to Scalable Vector Search from Intel Corporation ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by email or electronic submission, following the [instructions](CLA_submission_instructions.md). This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
<table>
    <tr>
        <td>Signature</td>
        <td><div style="width:300px;height:60px"></div></td>
    </tr>
    <tr>
        <td>Name</td>
        <td><div style="width:300px;height:60px"></div></td>
...
This work is adapted from [Harmony Contributor Agreement Templates](https://harmonyagreements.org/agreements.html),
