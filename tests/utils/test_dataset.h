...
// Overload for distance functor types (DistanceL2, DistanceIP, DistanceCosineSimilarity, etc.).
// This enables test code that passes a concrete functor instance instead of the enum.
