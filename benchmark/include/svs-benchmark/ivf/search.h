...
inline constexpr std::string_view search_benchmark_name() { return "ivf_static_search"; }
...
struct IVFState {
  public:
    svs::index::ivf::IVFSearchParameters search_parameters_;
    size_t num_threads_;
  ...
  public:
    ...
    explicit IVFState(const Index& index)
        : IVFState(index.get_search_parameters(), index.get_num_threads()) {}

    // Saving
    static constexpr svs::lib::Version save_version{0, 0, 0};
    static constexpr std::string_view serialization_schema = "benchmark_ivf_state";
  ...
  public:
    ...
    static SearchJob example() {
        return SearchJob{
            ...
            "path/to/clustering dir",            // clustering dir
            "path/not/used",                     // Not applicable
            "path/to/data",                      // data
            ...
            {{10, 1.0}, {10, 4.0}}               // preset_parameters
        };
    }
    ...
    ///// Save/Load
    static constexpr svs::lib::Version save_version{0, 0, 0};
    static constexpr std::string_view serialization_schema = "benchmark_ivf_search_job";
    svs::lib::SaveTable save() const {
        return svs::lib::SaveTable(
            serialization_schema,
            save_version,
