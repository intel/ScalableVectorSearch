...
CC=gcc CXX=g++ cmake .. -S /workspace -B /workspace/bindings/cpp/build_cpp_bindings \
  -DSVS_BUILD_RUNTIME_TESTS=ON -DCMAKE_INSTALL_PREFIX=/workspace/install_cpp_bindings -DCMAKE_INSTALL_LIBDIR=lib -DSVS_RUNTIME_ENABLE_LVQ_LEANVEC=${ENABLE_LVQ_LEANVEC:-ON}
cmake --build . -j
cmake --install .
